...
namespace dcdsystem {
   ...
   static constexpr uint32_t refund_delay_sec      = 2 * 60 * 60; // two hours
   ...
   * 
   * Just like in the `dcd.bios` sample contract implementation, there are a few actions which are not implemented at the contract level (`newaccount`, `updateauth`, `deleteauth`, `linkauth`, `unlinkauth`, `canceldelay`, `onerror`, `setabi`, `setcode`), they are just declared in the contract so they will show in the contract's ABI and users will be able to push those actions to the chain via the account holding the `dcd.system` contract, but the implementation is at the DCD core level. They are referred to as DCD native actions.
   * 
   ...
   */
   ...
   struct [[dcd::table, dcd::contract("dcd.system")]] name_bid {
     name            newname;
     name            high_bidder;
   ...
   struct [[dcd::table, dcd::contract("dcd.system")]] bid_refund {
      name         bidder;
      asset        amount;

      uint64_t primary_key()const { return bidder.value; }
   };
   typedef dcd::multi_index< "namebids"_n, name_bid,
   ...
   struct [[dcd::table("global"), dcd::contract("dcd.system")]] dcd_global_state : dcd::blockchain_parameters {
   ...
   struct [[dcd::table("global2"), dcd::contract("dcd.system")]] dcd_global_state2 {
      dcd_global_state2(){}
   ...
   struct [[dcd::table("global3"), dcd::contract("dcd.system")]] dcd_global_state3 {
      dcd_global_state3() { }
   ...
   struct [[dcd::table("global4"), dcd::contract("dcd.system")]] dcd_global_state4 {
      dcd_global_state4() { }
   ...
   struct [[dcd::table, dcd::contract("dcd.system")]] producer_info {
      name                                                     owner;
      double                                                   total_votes = 0;
      dcd::public_key                                        producer_key; /// a packed public key object
      bool                                                     is_active = true;
      std::string                                              url;
      ...
      dcd::block_signing_authority get_producer_authority()const {
         if( producer_authority.has_value() ) {
            bool zero_threshold = std::visit( [](auto&& auth ) -> bool {
               return (auth.threshold == 0);
            }, *producer_authority );
            // zero_threshold could be true despite the validation done in regproducer2 because the v1.9.0 dcd.system
            // contract has a bug which may have modified the producer table such that the producer_authority field
            // contains a default constructed dcd::block_signing_authority (which has a 0 threshold and so is invalid).
   ...
   struct [[dcd::table, dcd::contract("dcd.system")]] producer_info2 {
      name            owner;
   ...
   struct [[dcd::table, dcd::contract("dcd.system")]] voter_info {
   ...
   typedef dcd::multi_index< "voters"_n, voter_info >  voters_table;
   ...
   typedef dcd::singleton< "global"_n, dcd_global_state >   global_state_singleton;

   typedef dcd::singleton< "global2"_n, dcd_global_state2 > global_state2_singleton;

   typedef dcd::singleton< "global3"_n, dcd_global_state3 > global_state3_singleton;
   ...
   struct [[dcd::table, dcd::contract("dcd.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[dcd::table, dcd::contract("dcd.system")]] refund_request {
      name            owner;
      time_point_sec  request_time;
      dcd::asset    net_amount;
      dcd::asset    cpu_amount;
   ...
   typedef dcd::multi_index< "userres"_n, user_resources >      user_resources_table;
   typedef dcd::multi_index< "delband"_n, delegated_bandwidth > del_bandwidth_table;
   typedef dcd::multi_index< "refunds"_n, refund_request >      refunds_table;
   ...
   struct [[dcd::table,dcd::contract("dcd.system")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
   ...
   typedef dcd::multi_index< "rexpool"_n, rex_pool > rex_pool_table;
   ...
   struct [[dcd::table,dcd::contract("dcd.system")]] rex_return_pool {
      uint8_t        version = 0;
   ...
   typedef dcd::multi_index< "rexretpool"_n, rex_return_pool > rex_return_pool_table;
   ...
   struct [[dcd::table,dcd::contract("dcd.system")]] rex_return_buckets {
      uint8_t                           version = 0;
   ...
   typedef dcd::multi_index< "retbuckets"_n, rex_return_buckets > rex_return_buckets_table;
   ...
   struct [[dcd::table,dcd::contract("dcd.system")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
   ...
   typedef dcd::multi_index< "rexfund"_n, rex_fund > rex_fund_table;
   ...
   struct [[dcd::table,dcd::contract("dcd.system")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
   ...
   typedef dcd::multi_index< "rexbal"_n, rex_balance > rex_balance_table;
   ...
   struct [[dcd::table,dcd::contract("dcd.system")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
   ...
   typedef dcd::multi_index< "cpuloan"_n, rex_loan,
   ...
   typedef dcd::multi_index< "netloan"_n, rex_loan,
                               indexed_by<"byexpr"_n,  const_mem_fun<rex_loan, uint64_t, &rex_loan::by_expr>>,
                               indexed_by<"byowner"_n, const_mem_fun<rex_loan, uint64_t, &rex_loan::by_owner>>
                             > rex_net_loan_table;

   struct [[dcd::table,dcd::contract("dcd.system")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
      asset               stake_change;
      dcd::time_point   order_time;
      bool                is_open = true;
   ...
   typedef dcd::multi_index< "rexqueue"_n, rex_order,
   ...
   struct [[dcd::table("powup.state"),dcd::contract("dcd.system")]] powerup_state {
   ...
   typedef dcd::singleton<"powup.state"_n, powerup_state> powerup_state_singleton;

   struct [[dcd::table("powup.order"),dcd::contract("dcd.system")]] powerup_order {
      uint8_t              version = 0;
      uint64_t             id;
      name                 owner;
      int64_t              net_weight;
   ...
   typedef dcd::multi_index< "powup.order"_n, powerup_order,
    ...
    */
   class [[dcd::contract("dcd.system")]] system_contract : public native {
      ...
      private:
         ...
         dcd_global_state       _gstate;
         dcd_global_state2      _gstate2;
         dcd_global_state3      _gstate3;
         dcd_global_state4      _gstate4;
      ...
      public:
         ...
         static constexpr dcd::name token_account{"dcd.token"_n};
         static constexpr dcd::name fee_account{"dcd.feebank"_n};
         static constexpr dcd::name ram_account{"dcd.ram"_n};
         static constexpr dcd::name ramfee_account{"dcd.ramfee"_n};
         static constexpr dcd::name stake_account{"dcd.stake"_n};
         static constexpr dcd::name bpay_account{"dcd.bpay"_n};
         static constexpr dcd::name vpay_account{"dcd.vpay"_n};
         static constexpr dcd::name names_account{"dcd.names"_n};
         static constexpr dcd::name saving_account{"dcd.saving"_n};
         static constexpr dcd::name rex_account{"dcd.rex"_n};
         static constexpr dcd::name reserv_account{"dcd.reserv"_n};
         static constexpr dcd::name null_account{"dcd.null"_n};
         ...
         static symbol get_core_symbol( name system_account = "dcd"_n ) {
...
//         void setacctcpu( const name& account, const std::optional<int64_t>& cpu_weight );
          ...
          */
         [[dcd::action]]
         void activate( const dcd::checksum256& feature_digest );
          ...
          */
         [[dcd::action]]
         void regproducer2( const name& producer, const dcd::block_signing_authority& producer_authority, const std::string& url, uint16_t location );
	  ...
	  /**
          ...
          */
         [[dcd::action]]
         void setparams( const dcd::blockchain_parameters& params );
          ...
          *     The remaining inflation will be sent to the `dcd.saving` account.
...
//         using setacctcpu_action = dcd::action_wrapper<"setacctcpu"_n, &system_contract::setacctcpu>;
         using activate_action = dcd::action_wrapper<"activate"_n, &system_contract::activate>;
         using delegatebw_action = dcd::action_wrapper<"delegatebw"_n, &system_contract::delegatebw>;
         using deposit_action = dcd::action_wrapper<"deposit"_n, &system_contract::deposit>;
         using withdraw_action = dcd::action_wrapper<"withdraw"_n, &system_contract::withdraw>;
         using buyrex_action = dcd::action_wrapper<"buyrex"_n, &system_contract::buyrex>;
         using unstaketorex_action = dcd::action_wrapper<"unstaketorex"_n, &system_contract::unstaketorex>;
         using sellrex_action = dcd::action_wrapper<"sellrex"_n, &system_contract::sellrex>;
         using cnclrexorder_action = dcd::action_wrapper<"cnclrexorder"_n, &system_contract::cnclrexorder>;
         using rentcpu_action = dcd::action_wrapper<"rentcpu"_n, &system_contract::rentcpu>;
         using rentnet_action = dcd::action_wrapper<"rentnet"_n, &system_contract::rentnet>;
         using fundcpuloan_action = dcd::action_wrapper<"fundcpuloan"_n, &system_contract::fundcpuloan>;
         using fundnetloan_action = dcd::action_wrapper<"fundnetloan"_n, &system_contract::fundnetloan>;
         using defcpuloan_action = dcd::action_wrapper<"defcpuloan"_n, &system_contract::defcpuloan>;
         using defnetloan_action = dcd::action_wrapper<"defnetloan"_n, &system_contract::defnetloan>;
         using updaterex_action = dcd::action_wrapper<"updaterex"_n, &system_contract::updaterex>;
         using rexexec_action = dcd::action_wrapper<"rexexec"_n, &system_contract::rexexec>;
         using setrex_action = dcd::action_wrapper<"setrex"_n, &system_contract::setrex>;
         using mvtosavings_action = dcd::action_wrapper<"mvtosavings"_n, &system_contract::mvtosavings>;
         using mvfrsavings_action = dcd::action_wrapper<"mvfrsavings"_n, &system_contract::mvfrsavings>;
         using consolidate_action = dcd::action_wrapper<"consolidate"_n, &system_contract::consolidate>;
         using closerex_action = dcd::action_wrapper<"closerex"_n, &system_contract::closerex>;
         using undelegatebw_action = dcd::action_wrapper<"undelegatebw"_n, &system_contract::undelegatebw>;
         using buyram_action = dcd::action_wrapper<"buyram"_n, &system_contract::buyram>;
         using buyrambytes_action = dcd::action_wrapper<"buyrambytes"_n, &system_contract::buyrambytes>;
         using sellram_action = dcd::action_wrapper<"sellram"_n, &system_contract::sellram>;
         using refund_action = dcd::action_wrapper<"refund"_n, &system_contract::refund>;
         ...
         using delproducer_action = dcd::action_wrapper<"delproducer"_n, &system_contract::delproducer>;
         using voteproducer_action = dcd::action_wrapper<"voteproducer"_n, &system_contract::voteproducer>;
         using regproxy_action = dcd::action_wrapper<"regproxy"_n, &system_contract::regproxy>;
         using claimrewards_action = dcd::action_wrapper<"claimrewards"_n, &system_contract::claimrewards>;
         using rmvproducer_action = dcd::action_wrapper<"rmvproducer"_n, &system_contract::rmvproducer>;
         using updtrevision_action = dcd::action_wrapper<"updtrevision"_n, &system_contract::updtrevision>;
         using bidname_action = dcd::action_wrapper<"bidname"_n, &system_contract::bidname>;
         using bidrefund_action = dcd::action_wrapper<"bidrefund"_n, &system_contract::bidrefund>;
         using setpriv_action = dcd::action_wrapper<"setpriv"_n, &system_contract::setpriv>;
//         using setalimits_action = dcd::action_wrapper<"setalimits"_n, &system_contract::setalimits>;
         using setparams_action = dcd::action_wrapper<"setparams"_n, &system_contract::setparams>;
         using setinflation_action = dcd::action_wrapper<"setinflation"_n, &system_contract::setinflation>;
         using cfgpowerup_action = dcd::action_wrapper<"cfgpowerup"_n, &system_contract::cfgpowerup>;
      ...
      private:
         ...
         //defined in dcd.system.cpp
         static dcd_global_state get_default_parameters();
         static dcd_global_state4 get_default_inflation_parameters();
