...
extern "C" __attribute__((dcd_wasm_import)) void set_wasm_parameters_packed(const void*, std::size_t);
#ifdef USE_DCD_CDT_1_7_X
extern "C" __attribute__((dcd_wasm_import)) uint32_t read_action_data( void* msg, uint32_t len );
extern "C" __attribute__((dcd_wasm_import))    uint32_t action_data_size();
#endif
...
class [[dcd::contract]] wasm_config_bios : public dcd::contract {
 public:
   using contract::contract;
   [[dcd::action]] void setwparams(const wasm_config& cfg) {
