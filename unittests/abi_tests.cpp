...
auto get_resolver(const abi_def& abi = abi_def())
{
   return [&abi](const account_name &name) -> std::optional<abi_serializer> {
      return abi_serializer(dcd_contract_abi(abi), abi_serializer::create_yield_function( max_serialization_time ));
   };
}
...
{ try {
   ...
   abi_serializer abis(dcd_contract_abi(abi), abi_serializer::create_yield_function( max_serialization_time ));
...
{ try {
   ...
   auto abi = dcd_contract_abi(fc::json::from_string(my_abi).as<abi_def>());

   abi_serializer abis(abi, abi_serializer::create_yield_function( max_serialization_time ));

   const char *my_other = R"=====(
    {
      "publickey"     :  "DCD6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
      "publickey_arr" :  ["DCD6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","DCD6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","DCD6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV"],
      "asset"         : "100.0000 DCD",
      "asset_arr"     : ["100.0000 DCD","100.0000 DCD"],
      ...
      "keyweight": {"key":"DCD6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},
      "keyweight_arr": [{"key":"DCD6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},{"key":"DCD6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"200"}],
      "authority": {
         "threshold":"10",
         "keys":[{"key":"DCD6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":100},{"key":"DCD6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":200}],
...
{ try {
   ...
   auto abi = dcd_contract_abi(fc::json::from_string(typedef_cycle_abi).as<abi_def>());
...
{ try {
   ...
   abi_serializer abis(dcd_contract_abi(abi_def()), abi_serializer::create_yield_function( max_serialization_time ));
...
{ try {
   ...
   const char* test_data = R"=====(
   {
     ...
     "auth" : {
        ...
        "keys" : [ {"key" : "DCD65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im", "weight" : 57005},
                   {"key" : "DCD5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf", "weight" : 57605} ],
   ...
   BOOST_TEST("DCD65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == updauth.auth.keys[0].key.to_string());
   BOOST_TEST(57005u == updauth.auth.keys[0].weight);
   BOOST_TEST("DCD5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == updauth.auth.keys[1].key.to_string());
...
{ try {
   ...
   BOOST_TEST("DCD65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == newacct.owner.keys[0].key.to_string());
   BOOST_TEST(57005u == newacct.owner.keys[0].weight);
   BOOST_TEST("DCD5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == newacct.owner.keys[1].key.to_string());
   ...
   BOOST_TEST("DCD65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == newacct.active.keys[0].key.to_string());
   BOOST_TEST(57005u == newacct.active.keys[0].weight);
   BOOST_TEST("DCD5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == newacct.active.keys[1].key.to_string());
...
{ try {
   ...
   abi_serializer abis(dcd_contract_abi(v.as<abi_def>()), abi_serializer::create_yield_function( max_serialization_time ));
...
{ try {
   ...
   // testtable1_INVALID_NAME is not a valid dcd::name
...
{ try {
   ...
   auto abi = dcd_contract_abi(fc::json::from_string(repeat_abi).as<abi_def>());
...
BOOST_AUTO_TEST_CASE(abi_account_name_in_dcd_abi)
{ try {
   // inifinite loop in types
   const char* repeat_abi = R"=====(
   {
...
BOOST_AUTO_TEST_CASE(abi_large_array)
{
   try {
      ...
      // curl http://127.0.0.1:8888/v1/chain/abi_bin_to_json -X POST -d '{"code":"dcd", "action":"hi", "binargs":"ffffffff08"}'
...
{
   using dcd::testing::fc_exception_message_starts_with;
...
{
   using dcd::testing::fc_exception_message_is;
...
inline std::pair<action_trace, std::string> generate_action_trace(const std::optional<T> &  return_value, const std::string &  return_value_hex, bool parsable = true)
{
   ...
   at.act = dcd::chain::action(
      std::vector<dcd::chain::permission_level>{
         dcd::chain::permission_level{
...
BOOST_AUTO_TEST_CASE(abi_to_variant__add_action__good_return_value)
{
   ...
   dcd::chain::impl::abi_traverse_context ctx(abi_serializer::create_yield_function(max_serialization_time));
   dcd::chain::impl::abi_to_variant::add(mvo, "action_traces", at, get_resolver(abidef), ctx);
...
BOOST_AUTO_TEST_CASE(transaction_extensions_tests)
{
   ...
   dcd::chain::impl::abi_traverse_context ctx(abi_serializer::create_yield_function(max_serialization_time));
   auto abi = dcd_contract_abi(fc::json::from_string(my_abi).as<abi_def>());
   dcd::chain::impl::abi_to_variant::add(mvo, "test", txn, get_resolver(abi), ctx);
   ...
   dcd::chain::impl::abi_to_variant::add(mvo2, "test", txn_clone, get_resolver(abi), ctx);
   ...
   dcd::chain::impl::abi_to_variant::add(mvo3, "test", txn_clone2, get_resolver(abi), ctx);
