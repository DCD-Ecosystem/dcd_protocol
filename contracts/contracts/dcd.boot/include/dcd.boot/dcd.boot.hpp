...
namespace dcdboot {
   ...
   /**
    * @defgroup dcdboot dcd.boot
    * @ingroup dcdcontracts
    *
    * dcd.boot is a extremely minimalistic system contract that only supports the native actions and an
    * activate action that allows activating desired protocol features prior to deploying a system contract
    * with more features such as dcd.bios or dcd.system.
    *
    * @{
    */
   class [[dcd::contract("dcd.boot")]] boot : public dcd::contract {
      public:
   ...
   /** @}*/ // end of @defgroup dcdboot dcd.boot
} /// namespace dcdboot
