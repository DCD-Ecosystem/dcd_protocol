...
# dcdnode_run_test
#
# General test that tests a wide range of general use actions around dcdnode and dcdksd
#
###############################################################
...
try:
    ...
    if localTest and not dontLaunch:
        ...
        specificExtradcdnodeArgs={ 0 : " --backing-store=chainbase",
    ...
    contractDir="unittests/contracts/dcd.token"
    wasmFile="dcd.token.wasm"
    abiFile="dcd.token.abi"
