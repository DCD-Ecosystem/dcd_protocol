...
###############################################################
# dcd_blocklog_prune_test.py
#
# Test dcd-blocklog prune-transaction 
# 
...
# Afterwards, it uses dcd-blocklog to prune the transaction with context free
...
try:
    ...
    assert cluster.launch(
        ...
        specificExtradcdnodeArgs={
            0: "--plugin dcd::state_history_plugin --trace-history --disable-replay-opts --sync-fetch-span 200 --state-history-endpoint 127.0.0.1:8080 --plugin dcd::net_api_plugin --enable-stale-production",
    ...
    trans = producerNode.getDcdAccount("payloadless")
