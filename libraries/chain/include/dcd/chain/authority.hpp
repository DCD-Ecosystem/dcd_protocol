...
FC_REFLECT(dcd::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(dcd::chain::key_weight, (key)(weight) )
FC_REFLECT(dcd::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(dcd::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(dcd::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(dcd::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(dcd::chain::shared_public_key, (pubkey))
