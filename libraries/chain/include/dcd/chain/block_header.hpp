...
namespace dcd { namespace chain {
   ...
   struct block_header
   {
      ...
      std::optional<shared_rate_info>   new_rate;
...
FC_REFLECT(dcd::chain::block_header,
           (timestamp)(producer)(confirmed)(previous)
           (transaction_mroot)(action_mroot)
           (schedule_version)(new_producers)
           (rate_version)(new_rate)
           (header_extensions))

FC_REFLECT_DERIVED(dcd::chain::signed_block_header, (dcd::chain::block_header), (producer_signature))
