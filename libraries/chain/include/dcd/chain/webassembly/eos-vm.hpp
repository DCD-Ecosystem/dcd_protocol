...
using eos_vm_backend_t = dcd::vm::backend<eos_vm_host_functions_t, Impl, webassembly::eos_vm_runtime::apply_options>;

template <typename Options>
using eos_vm_null_backend_t = dcd::vm::backend<eos_vm_host_functions_t, dcd::vm::null_backend, Options>;
...
class eos_vm_runtime : public dcd::chain::wasm_runtime_interface {
   public:
      eos_vm_runtime();
...
}}}}// dcd::chain::webassembly::eos_vm_runtime
