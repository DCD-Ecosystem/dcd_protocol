...
FC_REFLECT(dcd::chain::eosvmoc::initialize_message, )
FC_REFLECT(dcd::chain::eosvmoc::initalize_response_message, (error_message))
FC_REFLECT(dcd::chain::eosvmoc::code_tuple, (code_id)(vm_version))
FC_REFLECT(dcd::chain::eosvmoc::compile_wasm_message, (code))
FC_REFLECT(dcd::chain::eosvmoc::evict_wasms_message, (codes))
FC_REFLECT(dcd::chain::eosvmoc::code_compilation_result_message, (start)(apply_offset)(starting_memory_pages)(initdata_prologue_size))
FC_REFLECT(dcd::chain::eosvmoc::compilation_result_unknownfailure, )
FC_REFLECT(dcd::chain::eosvmoc::compilation_result_toofull, )
FC_REFLECT(dcd::chain::eosvmoc::wasm_compilation_result_message, (code)(result)(cache_free_bytes))
