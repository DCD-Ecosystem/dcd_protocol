...
#define OFFSET_OF_CONTROL_BLOCK_MEMBER(M) (-(int)dcd::chain::eosvmoc::memory::cb_offset + (int)offsetof(dcd::chain::eosvmoc::control_block, M))
#define OFFSET_OF_FIRST_INTRINSIC ((int)-dcd::chain::eosvmoc::memory::first_intrinsic_offset)
