...
FC_REFLECT(dcd::chain::eosvmoc::no_offset, );
FC_REFLECT(dcd::chain::eosvmoc::code_offset, (offset));
FC_REFLECT(dcd::chain::eosvmoc::intrinsic_ordinal, (ordinal));
FC_REFLECT(dcd::chain::eosvmoc::code_descriptor, (code_hash)(vm_version)(codegen_version)(code_begin)(start)(apply_offset)(starting_memory_pages)(initdata_begin)(initdata_size)(initdata_prologue_size));
