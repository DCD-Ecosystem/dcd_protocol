...
} // ns dcd::chain::dcdvmoc::detail

inline constexpr auto get_intrinsic_table() {
   return detail::generate_table(
      "dcdvmoc_internal.unreachable",
      "dcdvmoc_internal.grow_memory",
      "dcdvmoc_internal.div0_or_overflow",
      "dcdvmoc_internal.indirect_call_mismatch",
      "dcdvmoc_internal.indirect_call_oob",
      "dcdvmoc_internal.depth_assert",
      "dcd_injection.call_depth_assert",  //these two are never used by DCD VM OC but all intrinsics
      "dcd_injection.checktime",          //must be mapped
      "env.__ashlti3",
      "env.__ashrti3",
      "env.__lshlti3",
      "env.__lshrti3",
      ...
      "env.memcmp",
      "env.memset",
      "dcd_injection._dcd_f32_add",
      "dcd_injection._dcd_f32_sub",
      "dcd_injection._dcd_f32_mul",
      "dcd_injection._dcd_f32_div",
      "dcd_injection._dcd_f32_min",
      "dcd_injection._dcd_f32_max",
      "dcd_injection._dcd_f32_copysign",
      "dcd_injection._dcd_f32_abs",
      "dcd_injection._dcd_f32_neg",
      "dcd_injection._dcd_f32_sqrt",
      "dcd_injection._dcd_f32_ceil",
      "dcd_injection._dcd_f32_floor",
      "dcd_injection._dcd_f32_trunc",
      "dcd_injection._dcd_f32_nearest",
      "dcd_injection._dcd_f32_eq",
      "dcd_injection._dcd_f32_ne",
      "dcd_injection._dcd_f32_lt",
      "dcd_injection._dcd_f32_le",
      "dcd_injection._dcd_f32_gt",
      "dcd_injection._dcd_f32_ge",
      "dcd_injection._dcd_f64_add",
      "dcd_injection._dcd_f64_sub",
      "dcd_injection._dcd_f64_mul",
      "dcd_injection._dcd_f64_div",
      "dcd_injection._dcd_f64_min",
      "dcd_injection._dcd_f64_max",
      "dcd_injection._dcd_f64_copysign",
      "dcd_injection._dcd_f64_abs",
      "dcd_injection._dcd_f64_neg",
      "dcd_injection._dcd_f64_sqrt",
      "dcd_injection._dcd_f64_ceil",
      "dcd_injection._dcd_f64_floor",
      "dcd_injection._dcd_f64_trunc",
      "dcd_injection._dcd_f64_nearest",
      "dcd_injection._dcd_f64_eq",
      "dcd_injection._dcd_f64_ne",
      "dcd_injection._dcd_f64_lt",
      "dcd_injection._dcd_f64_le",
      "dcd_injection._dcd_f64_gt",
      "dcd_injection._dcd_f64_ge",
      "dcd_injection._dcd_f32_promote",
      "dcd_injection._dcd_f64_demote",
      "dcd_injection._dcd_f32_trunc_i32s",
      "dcd_injection._dcd_f64_trunc_i32s",
      "dcd_injection._dcd_f32_trunc_i32u",
      "dcd_injection._dcd_f64_trunc_i32u",
      "dcd_injection._dcd_f32_trunc_i64s",
      "dcd_injection._dcd_f64_trunc_i64s",
      "dcd_injection._dcd_f32_trunc_i64u",
      "dcd_injection._dcd_f64_trunc_i64u",
      "dcd_injection._dcd_i32_to_f32",
      "dcd_injection._dcd_i64_to_f32",
      "dcd_injection._dcd_ui32_to_f32",
      "dcd_injection._dcd_ui64_to_f32",
      "dcd_injection._dcd_i32_to_f64",
      "dcd_injection._dcd_i64_to_f64",
      "dcd_injection._dcd_ui32_to_f64",
      "dcd_injection._dcd_ui64_to_f64",
