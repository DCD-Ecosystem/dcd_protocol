...
class eosvmoc_runtime : public dcd::chain::wasm_runtime_interface {
   public:
...
struct eos_vm_oc_type_converter : public dcd::vm::type_converter<webassembly::interface, eos_vm_oc_execution_interface> {
   using base_type = dcd::vm::type_converter<webassembly::interface, eos_vm_oc_execution_interface>;
