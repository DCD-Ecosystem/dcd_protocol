...
CHAINBASE_SET_INDEX_TYPE(dcd::chain::generated_transaction_object, dcd::chain::generated_transaction_multi_index)

FC_REFLECT(dcd::chain::generated_transaction_object, (trx_id)(sender)(sender_id)(payer)(delay_until)(expiration)(published)(packed_trx))
