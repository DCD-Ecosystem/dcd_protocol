...
#include <dcd/chain/backing_store/db_chainbase_iter_store.hpp>
#include <dcd/chain/backing_store/db_secondary_key_helper.hpp>
...
# warning look into if we can make any of the db_** methods and idx***'s methods const and provide a const interface
   ...
   public:
      ...
      uint64_t set_proposed_rate( double new_rate ); 
