...
CHAINBASE_SET_INDEX_TYPE(dcd::chain::kv_db_config_object, dcd::chain::kv_db_config_index)
CHAINBASE_SET_INDEX_TYPE(dcd::chain::kv_object, dcd::chain::kv_index)
FC_REFLECT(dcd::chain::kv_db_config_object, (backing_store))
FC_REFLECT(dcd::chain::kv_object_view, (contract)(kv_key)(kv_value)(payer))
FC_REFLECT(dcd::chain::kv_object, (contract)(kv_key)(kv_value)(payer))
