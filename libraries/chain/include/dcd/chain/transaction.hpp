...
FC_REFLECT(dcd::chain::deferred_transaction_generation_context, (sender_trx_id)(sender_id)(sender) )
FC_REFLECT( dcd::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)
                                              (max_net_usage_words)(max_cpu_usage_ms)(delay_sec) )
FC_REFLECT_DERIVED( dcd::chain::transaction, (dcd::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions)(fee) )
FC_REFLECT_DERIVED( dcd::chain::signed_transaction, (dcd::chain::transaction), (signatures)(context_free_data) )
FC_REFLECT_ENUM( dcd::chain::packed_transaction_v0::compression_type, (none)(zlib))
// @ignore unpacked_trx trx_id
FC_REFLECT( dcd::chain::packed_transaction_v0, (signatures)(compression)(packed_context_free_data)(packed_trx) )
// @ignore estimated_size unpacked_trx trx_id
FC_REFLECT( dcd::chain::packed_transaction, (compression)(prunable_data)(packed_trx) )
FC_REFLECT( dcd::chain::packed_transaction::prunable_data_type, (prunable_data));
FC_REFLECT( dcd::chain::packed_transaction::prunable_data_type::none, (digest))
FC_REFLECT( dcd::chain::packed_transaction::prunable_data_type::partial, (signatures)( context_free_segments))
FC_REFLECT( dcd::chain::packed_transaction::prunable_data_type::full, (signatures)( context_free_segments))
// @ignore context_free_segments
FC_REFLECT( dcd::chain::packed_transaction::prunable_data_type::full_legacy, (signatures)( packed_context_free_data))
