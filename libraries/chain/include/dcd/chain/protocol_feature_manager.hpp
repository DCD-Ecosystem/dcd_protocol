...
FC_REFLECT(dcd::chain::protocol_feature_subjective_restrictions,
               (earliest_allowed_activation_time)(preactivation_required)(enabled))

// @ignore _type
FC_REFLECT(dcd::chain::protocol_feature_base,
               (protocol_feature_type)(description_digest)(dependencies)(subjective_restrictions))

// @ignore _codename
FC_REFLECT_DERIVED(dcd::chain::builtin_protocol_feature, (dcd::chain::protocol_feature_base),
