...
CHAINBASE_SET_INDEX_TYPE(dcd::chain::code_object, dcd::chain::code_index)

FC_REFLECT(dcd::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
