...
#include <dcd/chain/action_receipt.hpp>
...
FC_REFLECT( dcd::chain::account_delta,
            (account)(delta) )

FC_REFLECT( dcd::chain::action_trace,
...
// @ignore except_ptr
FC_REFLECT( dcd::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
