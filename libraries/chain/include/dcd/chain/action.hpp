...
namespace dcd { namespace chain {
    ...
    *  In the context of dcd, every action is dispatched to the handler defined
...
FC_REFLECT( dcd::chain::permission_level, (actor)(permission) )
FC_REFLECT( dcd::chain::action_base, (account)(name)(authorization) )
FC_REFLECT_DERIVED( dcd::chain::action, (dcd::chain::action_base), (data) )
