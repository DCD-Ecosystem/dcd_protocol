...
CHAINBASE_SET_INDEX_TYPE(dcd::chain::permission_link_object, dcd::chain::permission_link_index)

FC_REFLECT(dcd::chain::permission_link_object, (account)(code)(message_type)(required_permission))
