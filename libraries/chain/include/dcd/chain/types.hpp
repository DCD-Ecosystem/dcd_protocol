...
namespace dcd { namespace chain {
   ...
   enum object_type
   {
      ...
      action_fee_vote_object_type,
      OBJECT_TYPE_COUNT ///< Sentry value which contains the number of different object types
   };

   /**
    *  Important notes on using chainbase objects in DCD code:
    *
    ...
    *  others are due to requirements to ensure determinism in the DCD chain library.
    *
...
FC_REFLECT_EMPTY( dcd::chain::void_t )
