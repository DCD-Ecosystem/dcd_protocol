...
CHAINBASE_SET_INDEX_TYPE(dcd::chain::table_id_object, dcd::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(dcd::chain::key_value_object, dcd::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(dcd::chain::index64_object, dcd::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(dcd::chain::index128_object, dcd::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(dcd::chain::index256_object, dcd::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(dcd::chain::index_double_object, dcd::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(dcd::chain::index_long_double_object, dcd::chain::index_long_double_index)

FC_REFLECT(dcd::chain::table_id_object, (code)(scope)(table)(payer)(count) )
// @ignore t_id
FC_REFLECT(dcd::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(dcd::chain::index64_object)
REFLECT_SECONDARY(dcd::chain::index128_object)
REFLECT_SECONDARY(dcd::chain::index256_object)
REFLECT_SECONDARY(dcd::chain::index_double_object)
REFLECT_SECONDARY(dcd::chain::index_long_double_object)
