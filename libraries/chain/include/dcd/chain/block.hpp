#pragma once
#include <dcd/chain/block_header.hpp>
...
FC_REFLECT_ENUM( dcd::chain::transaction_receipt_header::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )
FC_REFLECT_ENUM( dcd::chain::signed_block::prune_state_type,
                 (incomplete)(complete)(complete_legacy) )

FC_REFLECT(dcd::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(dcd::chain::transaction_receipt_v0, (dcd::chain::transaction_receipt_header), (trx) )
FC_REFLECT(dcd::chain::additional_block_signatures_extension, (signatures));
FC_REFLECT_DERIVED(dcd::chain::signed_block_v0, (dcd::chain::signed_block_header), (transactions)(block_extensions) )

FC_REFLECT_DERIVED(dcd::chain::transaction_receipt, (dcd::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(dcd::chain::signed_block, (dcd::chain::signed_block_header), (prune_state)(transactions)(block_extensions) )
