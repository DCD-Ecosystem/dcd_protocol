...
CHAINBASE_SET_INDEX_TYPE(dcd::chain::permission_object, dcd::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(dcd::chain::permission_usage_object, dcd::chain::permission_usage_index)

FC_REFLECT(dcd::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(dcd::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(dcd::chain::permission_usage_object, (last_used))
