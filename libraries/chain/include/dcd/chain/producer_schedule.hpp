...
FC_REFLECT( dcd::chain::legacy::producer_key, (producer_name)(block_signing_key) )
FC_REFLECT( dcd::chain::legacy::producer_schedule_type, (version)(producers) )
FC_REFLECT( dcd::chain::block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( dcd::chain::producer_authority, (producer_name)(authority) )
FC_REFLECT( dcd::chain::producer_authority_schedule, (version)(producers) )
FC_REFLECT_DERIVED( dcd::chain::producer_schedule_change_extension, (dcd::chain::producer_authority_schedule), )

FC_REFLECT( dcd::chain::shared_block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( dcd::chain::shared_producer_authority, (producer_name)(authority) )
FC_REFLECT( dcd::chain::shared_producer_authority_schedule, (version)(producers) )
FC_REFLECT( dcd::chain::shared_rate_info, (version)(rate) )
FC_REFLECT( dcd::chain::producer_rate_info, (version)(rate) )
