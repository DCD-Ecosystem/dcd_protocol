...
namespace dcd { namespace ship_protocol {
...
#   pragma clang diagnostic ignored "-Winvalid-noreturn"
   [[noreturn]] inline void report_error(const std::string& s) { dcd::check(false, s); }
#   pragma clang diagnostic pop
   ...
   struct extension {
      uint16_t            type = {};
      dcd::input_stream data = {};
   };

   DCD_REFLECT(extension, type, data)
   ...
   // todo: switch to dcd::result. switch to new serializer string support.
   ...
   DCD_REFLECT(get_status_request_v0)
   ...
   DCD_REFLECT(block_position, block_num, block_id)
   ...
   struct get_status_result_v0 {
      ...
      dcd::checksum256 chain_id                = {}; // todo: switch to binary extension
   };

   DCD_REFLECT(get_status_result_v0, head, last_irreversible, trace_begin_block, trace_end_block,
                 chain_state_begin_block, chain_state_end_block, chain_id)

   // When using `get_blocks_request_v1`, `get_blocks_result_v0` will be returned for DCD version 2.0.x and before and
   // `get_blocks_result_v1` will be returned for DCD version 2.1 RC bug not stable. 
   ...
   DCD_REFLECT(get_blocks_request_v0, start_block_num, end_block_num, max_messages_in_flight, have_positions,
   ...
   DCD_REFLECT(get_blocks_request_v1, base get_blocks_request_v0, fetch_block_header)

   struct get_blocks_ack_request_v0 {
      uint32_t num_messages = {};
   };

   DCD_REFLECT(get_blocks_ack_request_v0, num_messages)
   ...
   DCD_REFLECT(get_blocks_result_base, head, last_irreversible, this_block, prev_block)

   struct get_blocks_result_v0 : get_blocks_result_base {
      std::optional<dcd::input_stream> block  = {};
      std::optional<dcd::input_stream> traces = {};
      std::optional<dcd::input_stream> deltas = {};
   };

   DCD_REFLECT(get_blocks_result_v0, base get_blocks_result_base, block, traces, deltas)
   ...
   DCD_REFLECT(row_v0, present, data)
   ...
   DCD_REFLECT(table_delta_v0, name, rows)
   ...
   DCD_REFLECT(row_v1, present, data)
   ...
   DCD_REFLECT(table_delta_v1, name, rows)
   ...
   DCD_REFLECT(permission_level, actor, permission)
   ...
   DCD_REFLECT(action, account, name, authorization, data)
   ...
   DCD_REFLECT(account_auth_sequence, account, sequence)
   DCD_COMPARE(account_auth_sequence);

   struct action_receipt_v0 {
      dcd::name                        receiver        = {};
      dcd::checksum256                 act_digest      = {};
      uint64_t                           global_sequence = {};
      uint64_t                           recv_sequence   = {};
      std::vector<account_auth_sequence> auth_sequence   = {};
      dcd::varuint32                   code_sequence   = {};
      dcd::varuint32                   abi_sequence    = {};
   };

   DCD_REFLECT(action_receipt_v0, receiver, act_digest, global_sequence, recv_sequence, auth_sequence, code_sequence,
                 abi_sequence)
   ...
   DCD_REFLECT(account_delta, account, delta)
   DCD_COMPARE(account_delta);

   struct action_trace_v0 {
      dcd::varuint32              action_ordinal         = {};
      dcd::varuint32              creator_action_ordinal = {};
   ...
   DCD_REFLECT(action_trace_v0, action_ordinal, creator_action_ordinal, receipt, receiver, act, context_free, elapsed,
   ...
   struct action_trace_v1 {
      ...
      std::optional<std::string>    except                 = {};
      std::optional<uint64_t>       error_code             = {};
      dcd::input_stream           return_value           = {};
   };

   DCD_REFLECT(action_trace_v1, action_ordinal, creator_action_ordinal, receipt, receiver, act, context_free, elapsed,
   ...
   struct prunable_data_type {
      struct none {
         dcd::checksum256 prunable_digest;
      };

      using segment_type = std::variant<dcd::checksum256, dcd::input_stream>;
      ...
      struct full {
         std::vector<dcd::signature>    signatures;
         std::vector<dcd::input_stream> context_free_segments;
      };

      struct full_legacy {
         std::vector<dcd::signature> signatures;
         dcd::input_stream           packed_context_free_data;
      };
   ...
   DCD_REFLECT(prunable_data_type, prunable_data)
   DCD_REFLECT(prunable_data_type::none, prunable_digest)
   DCD_REFLECT(prunable_data_type::partial, signatures, context_free_segments)
   DCD_REFLECT(prunable_data_type::full, signatures, context_free_segments)
   DCD_REFLECT(prunable_data_type::full_legacy, signatures, packed_context_free_data)

   struct partial_transaction_v0 {
      dcd::time_point_sec            expiration             = {};
      uint16_t                         ref_block_num          = {};
      uint32_t                         ref_block_prefix       = {};
      dcd::varuint32                 max_net_usage_words    = {};
      uint8_t                          max_cpu_usage_ms       = {};
      dcd::varuint32                 delay_sec              = {};
      std::vector<extension>           transaction_extensions = {};
      std::vector<dcd::signature>    signatures             = {};
      std::vector<dcd::input_stream> context_free_data      = {};
   };

   DCD_REFLECT(partial_transaction_v0, expiration, ref_block_num, ref_block_prefix, max_net_usage_words,
   ...
   DCD_REFLECT(partial_transaction_v1, expiration, ref_block_num, ref_block_prefix, max_net_usage_words,
   ...
   DCD_REFLECT(transaction_trace_v0, id, status, cpu_usage_us, net_usage_words, elapsed, net_usage, scheduled,
   ...
   struct producer_key {
      dcd::name       producer_name     = {};
      dcd::public_key block_signing_key = {};
   };

   DCD_REFLECT(producer_key, producer_name, block_signing_key)
   ...
   DCD_REFLECT(producer_schedule, version, producers)
   ...
   DCD_REFLECT(transaction_receipt_header, status, cpu_usage_us, net_usage_words)

   struct packed_transaction_v0 {
      std::vector<dcd::signature> signatures               = {};
      uint8_t                       compression              = {};
      dcd::input_stream           packed_context_free_data = {};
      dcd::input_stream           packed_trx               = {};
   };

   DCD_REFLECT(packed_transaction_v0, signatures, compression, packed_context_free_data, packed_trx)
   ...
   DCD_REFLECT(packed_transaction, compression, prunable_data, packed_trx)

   using transaction_variant_v0 = std::variant<dcd::checksum256, packed_transaction_v0>;

   struct transaction_receipt_v0 : transaction_receipt_header {
      transaction_variant_v0 trx = {};
   };

   DCD_REFLECT(transaction_receipt_v0, base transaction_receipt_header, trx)

   using transaction_variant = std::variant<dcd::checksum256, packed_transaction>;

   struct transaction_receipt : transaction_receipt_header {
      transaction_variant trx = {};
   };

   DCD_REFLECT(transaction_receipt, base transaction_receipt_header, trx)
   ...
   DCD_REFLECT(block_header, timestamp, producer, confirmed, previous, transaction_mroot, action_mroot,
   ...
   DCD_REFLECT(signed_block_header, base block_header, producer_signature)
   ...
   DCD_REFLECT(signed_block_v0, base signed_block_header, transactions, block_extensions)
   ...
   DCD_REFLECT(signed_block_v1, base signed_block_header, prune_state, transactions, block_extensions)
   ...
   struct get_blocks_result_v1 : get_blocks_result_base {
      ...
      dcd::opaque<std::vector<transaction_trace>> traces = {};
      dcd::opaque<std::vector<table_delta>>       deltas = {};
   };

   DCD_REFLECT(get_blocks_result_v1, base get_blocks_result_base, block, traces, deltas)

   struct get_blocks_result_v2 : get_blocks_result_base { 
      dcd::opaque<signed_block_variant>           block = {};
      dcd::opaque<signed_block_header>            block_header = {};
      dcd::opaque<std::vector<transaction_trace>> traces = {};
      dcd::opaque<std::vector<table_delta>>       deltas = {};
   };

   DCD_REFLECT(get_blocks_result_v2, base get_blocks_result_base, block, block_header, traces, deltas)
   ...
   DCD_REFLECT(transaction_header, expiration, ref_block_num, ref_block_prefix, max_net_usage_words, max_cpu_usage_ms,
                 delay_sec)
   ...
   DCD_REFLECT(transaction, base transaction_header, context_free_actions, actions, transaction_extensions)

   struct code_id {
      uint8_t            vm_type    = {};
      uint8_t            vm_version = {};
      dcd::checksum256 code_hash  = {};
   };

   DCD_REFLECT(code_id, vm_type, vm_version, code_hash)

   struct account_v0 {
      dcd::name            name          = {};
      dcd::block_timestamp creation_date = {};
      dcd::input_stream    abi           = {};
   };

   DCD_REFLECT(account_v0, name, creation_date, abi)
   ...
   struct account_metadata_v0 {
      dcd::name            name             = {};
      bool                   privileged       = {};
      dcd::time_point      last_code_update = {};
      std::optional<code_id> code             = {};
   };

   DCD_REFLECT(account_metadata_v0, name, privileged, last_code_update, code)
   ...
   struct code_v0 {
      ...
      uint8_t             vm_version = {};
      dcd::checksum256  code_hash  = {};
      dcd::input_stream code       = {};
   };

   DCD_REFLECT(code_v0, vm_type, vm_version, code_hash, code)
   ...
   DCD_REFLECT(contract_table_v0, code, scope, table, payer)
   ...
   struct contract_row_v0 {
      ...
      dcd::name         payer       = {};
      dcd::input_stream value       = {};
   };

   DCD_REFLECT(contract_row_v0, code, scope, table, primary_key, payer, value)
   ...
   DCD_REFLECT(contract_index64_v0, code, scope, table, primary_key, payer, secondary_key)
   ...
   DCD_REFLECT(contract_index128_v0, code, scope, table, primary_key, payer, secondary_key)
   ...
   struct contract_index256_v0 {
      ...
      uint64_t           primary_key   = {};
      dcd::name        payer         = {};
      dcd::checksum256 secondary_key = {};
   };

   DCD_REFLECT(contract_index256_v0, code, scope, table, primary_key, payer, secondary_key)
   ...
   DCD_REFLECT(contract_index_double_v0, code, scope, table, primary_key, payer, secondary_key)
   ...
   struct contract_index_long_double_v0 {
      ...
      uint64_t        primary_key   = {};
      dcd::name     payer         = {};
      dcd::float128 secondary_key = {};
   };

   DCD_REFLECT(contract_index_long_double_v0, code, scope, table, primary_key, payer, secondary_key)

   using contract_index_long_double = std::variant<contract_index_long_double_v0>;

   struct key_value_v0 {
      dcd::name         contract = {};
      dcd::input_stream key      = {};
      dcd::input_stream value    = {};
      dcd::name         payer    = {};
   };

   DCD_REFLECT(key_value_v0, contract, key, value, payer)
   ...
   DCD_REFLECT(key_weight, key, weight)
   ...
   DCD_REFLECT(block_signing_authority_v0, threshold, keys)
   ...
   DCD_REFLECT(producer_authority, producer_name, authority)
   ...
   DCD_REFLECT(producer_authority_schedule, version, producers)
   ...
   DCD_REFLECT(chain_config_v0, max_block_net_usage, target_block_net_usage_pct, max_transaction_net_usage,
   ...
   DCD_REFLECT(chain_config_v1, max_block_net_usage, target_block_net_usage_pct, max_transaction_net_usage,
               base_per_transaction_net_usage, net_usage_leeway, context_free_discount_net_usage_num,
               context_free_discount_net_usage_den, max_block_cpu_usage, target_block_cpu_usage_pct,
               max_transaction_cpu_usage, min_transaction_cpu_usage, max_transaction_lifetime,
               deferred_trx_expiration_window, max_transaction_delay, max_inline_action_size, max_inline_action_depth,
   ...
   DCD_REFLECT(global_property_v0, proposed_schedule_block_num, proposed_schedule, configuration)
   ...
   DCD_REFLECT(global_property_v1, proposed_schedule_block_num, proposed_schedule, configuration, chain_id)
   ...
   DCD_REFLECT(kv_database_config, max_key_size, max_value_size, max_iterators)
   ...
   DCD_REFLECT(wasm_config, max_mutable_global_bytes, max_table_elements, max_section_elements,
   ...
   struct generated_transaction_v0 {
      ...
      uint128_t           sender_id  = {};
      dcd::name         payer      = {};
      dcd::checksum256  trx_id     = {};
      dcd::input_stream packed_trx = {};
   };

   DCD_REFLECT(generated_transaction_v0, sender, sender_id, payer, trx_id, packed_trx)

   using generated_transaction = std::variant<generated_transaction_v0>;

   struct activated_protocol_feature_v0 {
      dcd::checksum256 feature_digest       = {};
      uint32_t           activation_block_num = {};
   };

   DCD_REFLECT(activated_protocol_feature_v0, feature_digest, activation_block_num)
   ...
   DCD_REFLECT(protocol_state_v0, activated_protocol_features)
   ...
   DCD_REFLECT(permission_level_weight, permission, weight)
   ...
   DCD_REFLECT(wait_weight, wait_sec, weight)
   ...
   DCD_REFLECT(authority, threshold, keys, accounts, waits)

   struct permission_v0 {
      dcd::name       owner        = {};
      dcd::name       name         = {};
      dcd::name       parent       = {};
      dcd::time_point last_updated = {};
      authority         auth         = {};
   };

   DCD_REFLECT(permission_v0, owner, name, parent, last_updated, auth)
   ...
   struct permission_link_v0 {
      dcd::name account             = {};
      dcd::name code                = {};
      dcd::name message_type        = {};
      dcd::name required_permission = {};
   };

   DCD_REFLECT(permission_link_v0, account, code, message_type, required_permission)
   ...
   DCD_REFLECT(resource_limits_v0, owner, net_weight, cpu_weight, ram_bytes)
   ...
   DCD_REFLECT(usage_accumulator_v0, last_ordinal, value_ex, consumed)
   ...
   DCD_REFLECT(resource_usage_v0, owner, net_usage, cpu_usage, ram_usage)
   ...
   DCD_REFLECT(resource_limits_state_v0, average_block_net_usage, average_block_cpu_usage, total_net_weight,
   ...
   DCD_REFLECT(resource_limits_ratio_v0, numerator, denominator)
   ...
   DCD_REFLECT(elastic_limit_parameters_v0, target, max, periods, max_multiplier, contract_rate, expand_rate)
   ...
   DCD_REFLECT(resource_limits_config_v0, cpu_limit_parameters, net_limit_parameters,
