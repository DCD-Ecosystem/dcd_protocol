...
//
// Abidcd provides specializations of to_key for the following types
...
// - Reflected structs
// - All smart-contract related types defined by abidcd
...
void to_key(const T& obj, S& stream) {
   if constexpr (std::is_floating_point_v<T>) {
      ...
      dcd::for_each_field(obj, [&](const auto& member) {
