# dcdjs ![npm](https://img.shields.io/npm/dw/dcdjs.svg)

Javascript API for integration with DCD-based blockchains using [DCD RPC API](https://developers.dcd.io/dcd-dcdnode/reference).

Documentation can be found [here](https://dcd.github.io/dcdjs)

## Installation

### NPM

The official distribution package can be found at [npm](https://www.npmjs.com/package/dcdjs).
...
```js
import { Api, JsonRpc, RpcError } from 'dcdjs';
...
```js
const { Api, JsonRpc, RpcError } = require('dcdjs');
