...
import { Api } from '../dcdjs-api';
import { JsonRpc } from '../dcdjs-jsonrpc';
import { JsSignatureProvider } from '../dcdjs-jssig';
...
describe('dcdjs-api', () => {
    ...
    it('getAbi returns an abi', async () => {
        const response = await api.getAbi('testdcdtoken');
    ...
    it('getContract returns a contract', async () => {
        const response = await api.getContract('testdcdtoken');
