...
#define ABIDCD_NODISCARD [[nodiscard]]

namespace abidcd {

template <typename State>
ABIDCD_NODISCARD bool set_error(State& state, std::string error) {
    state.error = std::move(error);
    return false;
}

ABIDCD_NODISCARD inline bool set_error(std::string& state, std::string error) {
