...
Javascript API for integration with DCD-based blockchains using [DCD RPC API](https://developers.eos.io/dcd-dcdnode/reference).

Documentation can be found [here](https://dcd.github.io/eosjs)
