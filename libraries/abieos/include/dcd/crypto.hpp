...
DCD_REFLECT(webauthn_public_key, key, user_presence, rpid);
DCD_COMPARE(webauthn_public_key);
...
DCD_REFLECT(webauthn_signature, compact_signature, auth_data, client_json);
DCD_COMPARE(webauthn_signature);
