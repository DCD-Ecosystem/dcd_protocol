...
// compile with dcd-cpp -o hello.wasm hello.cpp
//#include <dcd/dcd.hpp>
//#include <dcd/print.hpp>
//
// extern "C" {
//[[dcd::wasm_import]] void print_name(const char*);
//[[dcd::wasm_import]] void print_num(uint64_t);
//[[dcd::wasm_import]] void print_span(const char*, std::size_t);
//
