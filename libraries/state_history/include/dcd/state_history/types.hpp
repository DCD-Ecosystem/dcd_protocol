...
template <typename ST>
void pack_big_bytes(ST& ds, const dcd::chain::bytes& v) {
...
template <typename ST>
void pack_big_bytes(ST& ds, const std::optional<dcd::chain::bytes>& v) {
...
struct action_receipt_v0 {
   uint64_t                           receiver        = {};
   dcd::chain::digest_type          act_digest      = {};
...
struct partial_transaction_v0 {
   dcd::chain::time_point_sec               expiration             = {};
   uint16_t                                   ref_block_num          = {};
   uint32_t                                   ref_block_prefix       = {};
   fc::unsigned_int                           max_net_usage_words    = {};
   uint8_t                                    max_cpu_usage_ms       = {};
   fc::unsigned_int                           delay_sec              = {};
   dcd::chain::extensions_type              transaction_extensions = {};
...
// clang-format off
FC_REFLECT(dcd::state_history::table_delta, (struct_version)(name)(rows));
FC_REFLECT(dcd::state_history::block_position, (block_num)(block_id));
FC_REFLECT_EMPTY(dcd::state_history::get_status_request_v0);
FC_REFLECT(dcd::state_history::get_status_result_v0, (head)(last_irreversible)(trace_begin_block)(trace_end_block)(chain_state_begin_block)(chain_state_end_block)(chain_id));
FC_REFLECT(dcd::state_history::get_blocks_request_v0, (start_block_num)(end_block_num)(max_messages_in_flight)(have_positions)(irreversible_only)(fetch_block)(fetch_traces)(fetch_deltas));
FC_REFLECT_DERIVED(dcd::state_history::get_blocks_request_v1, (dcd::state_history::get_blocks_request_v0), (fetch_block_header));
FC_REFLECT(dcd::state_history::get_blocks_ack_request_v0, (num_messages));

FC_REFLECT(dcd::state_history::account_auth_sequence, (account)(sequence));
FC_REFLECT(dcd::state_history::account_delta, (account)(delta));
FC_REFLECT(dcd::state_history::permission_level,(actor)(permission));
FC_REFLECT(dcd::state_history::action_receipt_v0, (receiver)(act_digest)(global_sequence)(recv_sequence)(auth_sequence)(code_sequence)(abi_sequence));
FC_REFLECT(dcd::state_history::action, (account)(name)(authorization)(data));
FC_REFLECT(dcd::state_history::action_trace_v0, (action_ordinal)(creator_action_ordinal)(receipt)(receiver)(act)(context_free)(elapsed)(console)(account_ram_deltas)(except)(error_code));
FC_REFLECT(dcd::state_history::action_trace_v1, (action_ordinal)(creator_action_ordinal)(receipt)(receiver)(act)(context_free)(elapsed)(console)(account_ram_deltas)(account_disk_deltas)(except)(error_code)(return_value));
FC_REFLECT(dcd::state_history::partial_transaction_v0, (expiration)(ref_block_num)(ref_block_prefix)(max_net_usage_words)(max_cpu_usage_ms)(delay_sec)(transaction_extensions)(signatures)(context_free_data));
FC_REFLECT(dcd::state_history::partial_transaction_v1, (expiration)(ref_block_num)(ref_block_prefix)(max_net_usage_words)(max_cpu_usage_ms)(delay_sec)(transaction_extensions)(prunable_data));
FC_REFLECT(dcd::state_history::transaction_trace_v0,(id)(status)(cpu_usage_us)(net_usage_words)(elapsed)(net_usage)(scheduled)(action_traces)(account_ram_delta)(except)(error_code)(failed_dtrx_trace)(partial));
FC_REFLECT(dcd::state_history::transaction_trace_recurse, (recurse));
// clang-format on

namespace fc {
template <typename ST, typename T>
ST& operator<<(ST& strm, const dcd::state_history::opaque<T>& v) {
   v.pack_to(strm);
   return strm;
}
} // namespace fc
