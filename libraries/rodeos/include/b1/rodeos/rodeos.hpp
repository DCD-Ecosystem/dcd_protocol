...
struct rodeos_filter {
   ...
   rodeos_filter(dcd::name name, const std::string& wasm_filename);

   void process(rodeos_db_snapshot& snapshot, const dcd::ship_protocol::get_blocks_result_base& result,
