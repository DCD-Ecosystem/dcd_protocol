...
// todo: abidcd support for pair. Used by extensions_type.
template <typename S>
...
struct callbacks : action_callbacks<callbacks>,
   ...
   roddcd::chaindb_state& chaindb_state;
   roddcd::db_view_state& db_view_state;

   callbacks(wasm_ql::thread_state& thread_state, roddcd::chaindb_state& chaindb_state,
             roddcd::db_view_state& db_view_state)
