...
#include <dcd/trace_api/common.hpp>
#include <dcd/trace_api/metadata_log.hpp>
#include <dcd/trace_api/data_log.hpp>
...
FC_REFLECT(dcd::trace_api::slice_directory::index_header, (version))
