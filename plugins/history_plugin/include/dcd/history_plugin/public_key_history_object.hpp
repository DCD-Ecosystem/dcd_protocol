...
CHAINBASE_SET_INDEX_TYPE( dcd::public_key_history_object, dcd::public_key_history_multi_index )

FC_REFLECT( dcd::public_key_history_object, (public_key)(name)(permission) )
