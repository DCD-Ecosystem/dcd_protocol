...
CHAINBASE_SET_INDEX_TYPE( dcd::account_control_history_object, dcd::account_control_history_multi_index )

FC_REFLECT( dcd::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
