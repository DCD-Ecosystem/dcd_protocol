#include <dcd/chain_api_plugin/chain_api_plugin.hpp>
...
void chain_api_plugin::plugin_startup() {
   ...
   _http_plugin.add_api({
      ...
      CHAIN_RO_CALL(get_rate_schedule, 200, http_params_types::possible_no_params),
      ...
      CHAIN_RO_CALL(get_fees_approved, 200, http_params_types::params_required ),
      CHAIN_RO_CALL(get_oracles_all, 200, http_params_types::possible_no_params ),
      CHAIN_RO_CALL(get_fee_all, 200, http_params_types::possible_no_params ),
