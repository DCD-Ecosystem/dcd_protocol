...
#include <dcd/chain/types.hpp>
#include <dcd/chain/fixed_bytes.hpp>
...
//      uint64_t                             block_net_limit = 0;
   ...
   //   int64_t available = 0;
   //   int64_t max = 0;
   //   std::optional<chain::block_timestamp_type> last_usage_update_time;    // optional for backward dcdnode support
   //   std::optional<int64_t> current_used;  // optional for backward dcdnode support
...
//      int64_t                    ram_usage = 0;
   ...
   dcd::chain::backing_store_type get_backing_store() const;
   ...
   void walk_key_value_table(const name& code, const name& scope, const name& table, Function f) const
   {
      ...
      if (db_backing_store == dcd::chain::backing_store_type::CHAINBASE) {
         ...
         auto end = start.next();
         dcd::chain::backing_store::walk_rocksdb_entries_with_prefix(kv_database.get_kv_undo_stack(), start, end, writer);
      }
   }
   ...
   read_only::get_table_rows_result get_table_rows_by_seckey( const read_only::get_table_rows_params& p, const abi_def& abi, ConvFn conv )const {
      ...
      auto secondary_key_lower = dcd::chain::secondary_key_traits<secondary_key_type>::true_lowest();
      const auto primary_key_lower = std::numeric_limits<uint64_t>::lowest();
      auto secondary_key_upper = dcd::chain::secondary_key_traits<secondary_key_type>::true_highest();
...
FC_REFLECT( dcd::chain_apis::permission, (perm_name)(parent)(required_auth) )
FC_REFLECT(dcd::chain_apis::empty, )
FC_REFLECT(dcd::chain_apis::read_only::get_info_results,
...
FC_REFLECT(dcd::chain_apis::read_only::get_activated_protocol_features_params, (lower_bound)(upper_bound)(limit)(search_by_block_num)(reverse) )
FC_REFLECT(dcd::chain_apis::read_only::get_activated_protocol_features_results, (activated_protocol_features)(more) )
FC_REFLECT(dcd::chain_apis::read_only::get_block_params, (block_num_or_id))
FC_REFLECT(dcd::chain_apis::read_only::get_block_info_params, (block_num))
FC_REFLECT(dcd::chain_apis::read_only::get_block_header_state_params, (block_num_or_id))

FC_REFLECT( dcd::chain_apis::read_write::push_transaction_results, (transaction_id)(processed) )

FC_REFLECT( dcd::chain_apis::read_only::get_table_rows_params, (json)(code)(scope)(table)(table_key)(lower_bound)(upper_bound)(limit)(key_type)(index_position)(encode_type)(reverse)(show_payer) )
FC_REFLECT( dcd::chain_apis::read_only::get_kv_table_rows_params, (json)(code)(table)(index_name)(encode_type)(index_value)(lower_bound)(upper_bound)(limit)(reverse)(show_payer) )
FC_REFLECT( dcd::chain_apis::read_only::get_table_rows_result, (rows)(more)(next_key)(next_key_bytes) );

FC_REFLECT( dcd::chain_apis::read_only::get_table_by_scope_params, (code)(table)(lower_bound)(upper_bound)(limit)(reverse) )
FC_REFLECT( dcd::chain_apis::read_only::get_table_by_scope_result_row, (code)(scope)(table)(payer)(count));
FC_REFLECT( dcd::chain_apis::read_only::get_table_by_scope_result, (rows)(more) );

FC_REFLECT( dcd::chain_apis::read_only::get_currency_balance_params, (code)(account)(symbol));
FC_REFLECT( dcd::chain_apis::read_only::get_currency_stats_params, (code)(symbol));
FC_REFLECT( dcd::chain_apis::read_only::get_currency_stats_result, (supply)(max_supply)(issuer));

FC_REFLECT( dcd::chain_apis::read_only::get_producers_params, (json)(lower_bound)(limit) )
FC_REFLECT( dcd::chain_apis::read_only::get_producers_result, (rows)(total_producer_vote_weight)(more) );

FC_REFLECT_EMPTY( dcd::chain_apis::read_only::get_producer_schedule_params )
FC_REFLECT( dcd::chain_apis::read_only::get_producer_schedule_result, (active)(pending)(proposed) );

//Fee rate
FC_REFLECT_EMPTY( dcd::chain_apis::read_only::get_rate_schedule_params )
FC_REFLECT( dcd::chain_apis::read_only::get_rate_schedule_result, (active)(pending)(proposed) );

FC_REFLECT( dcd::chain_apis::read_only::get_scheduled_transactions_params, (json)(lower_bound)(limit) )
FC_REFLECT( dcd::chain_apis::read_only::get_scheduled_transactions_result, (transactions)(more) );

//FC_REFLECT( dcd::chain_apis::read_only::account_resource_info, (used)(available)(max)(last_usage_update_time)(current_used) )
FC_REFLECT( dcd::chain_apis::read_only::get_account_results,
            (account_name)(head_block_num)(head_block_time)(privileged)(last_code_update)(created)
            (core_liquid_balance)/*(ram_quota)(net_weight)(cpu_weight)(net_limit)(cpu_limit)(ram_usage)*/(permissions)
            (total_resources)(self_delegated_bandwidth)(refund_request)(voter_info)(rex_info) )
// @swap code_hash
FC_REFLECT( dcd::chain_apis::read_only::get_code_results, (account_name)(code_hash)(wast)(wasm)(abi) )
FC_REFLECT( dcd::chain_apis::read_only::get_code_hash_results, (account_name)(code_hash) )
FC_REFLECT( dcd::chain_apis::read_only::get_abi_results, (account_name)(abi) )
FC_REFLECT( dcd::chain_apis::read_only::get_account_params, (account_name)(expected_core_symbol) )
FC_REFLECT( dcd::chain_apis::read_only::get_code_params, (account_name)(code_as_wasm) )
FC_REFLECT( dcd::chain_apis::read_only::get_code_hash_params, (account_name) )
FC_REFLECT( dcd::chain_apis::read_only::get_abi_params, (account_name) )
FC_REFLECT( dcd::chain_apis::read_only::get_raw_code_and_abi_params, (account_name) )
FC_REFLECT( dcd::chain_apis::read_only::get_raw_code_and_abi_results, (account_name)(wasm)(abi) )
FC_REFLECT( dcd::chain_apis::read_only::get_raw_abi_params, (account_name)(abi_hash) )
FC_REFLECT( dcd::chain_apis::read_only::get_raw_abi_results, (account_name)(code_hash)(abi_hash)(abi) )
FC_REFLECT( dcd::chain_apis::read_only::producer_info, (producer_name) )
FC_REFLECT( dcd::chain_apis::read_only::abi_json_to_bin_params, (code)(action)(args) )
FC_REFLECT( dcd::chain_apis::read_only::abi_json_to_bin_result, (binargs) )
FC_REFLECT( dcd::chain_apis::read_only::abi_bin_to_json_params, (code)(action)(binargs) )
