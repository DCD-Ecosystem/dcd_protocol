...
FC_REFLECT( dcd::select_ids<fc::sha256>, (mode)(pending)(ids) )
FC_REFLECT( dcd::chain_size_message,
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id))
FC_REFLECT( dcd::handshake_message,
            (network_version)(chain_id)(node_id)(key)
            (time)(token)(sig)(p2p_address)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent)(generation) )
FC_REFLECT( dcd::go_away_message, (reason)(node_id) )
FC_REFLECT( dcd::time_message, (org)(rec)(xmt)(dst) )
FC_REFLECT( dcd::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( dcd::request_message, (req_trx)(req_blocks) )
FC_REFLECT( dcd::sync_request_message, (start_block)(end_block) )
FC_REFLECT( dcd::trx_message_v1, (trx_id)(trx) )
