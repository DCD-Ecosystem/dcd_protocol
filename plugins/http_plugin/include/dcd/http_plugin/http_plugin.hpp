         ...
         try {
            if constexpr (params_type == http_params_types::no_params_required || params_type == http_params_types::possible_no_params) {
               ...
               if constexpr (params_type == http_params_types::no_params_required) {
                  DCD_THROW(chain::invalid_http_request, "no parameter should be given");
               }
            }
...
FC_REFLECT(dcd::error_results::error_info::error_detail, (message)(file)(line_number)(method))
FC_REFLECT(dcd::error_results::error_info, (code)(name)(what)(details))
FC_REFLECT(dcd::error_results, (code)(message)(error))
FC_REFLECT(dcd::http_plugin::get_supported_apis_result, (apis))
