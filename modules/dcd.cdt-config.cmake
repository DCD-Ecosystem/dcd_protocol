if(DCD_CDT_ROOT STREQUAL "" OR NOT DCD_CDT_ROOT)
   set(DCD_CDT_ROOT "@CDT_ROOT_DIR@")
endif()

list(APPEND CMAKE_MODULE_PATH ${DCD_CDT_ROOT}/lib/cmake/dcd.cdt)
if (NOT DCD_WASM_OLD_BEHAVIOR STREQUAL "Off")
    set(DCD_WASM_OLD_BEHAVIOR "On")
    include(DcdWasmToolchain)
endif()

include(DcdCDTMacros)
...
function(DCD_CHECK_VERSION output version hard_min soft_max hard_max) # optional 6th argument for error message
