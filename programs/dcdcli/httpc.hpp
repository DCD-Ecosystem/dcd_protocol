...
namespace dcd { namespace client { namespace http {
   ...
   const string get_rate_func = chain_func_base + "/get_rate_schedule";
   const string get_action_fee = chain_func_base + "/get_action_fee";
   ...
   const string dcdksd_stop = "/v1/" + string(client::config::key_store_executable_name) + "/stop";
