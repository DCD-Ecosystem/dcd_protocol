...
```sh
# command-line
dcdnode ... --plugin dcd::state_history_plugin [operations] [options]
```

## Operations

These can only be specified from the `dcdnode` command-line:

```console
Command Line Options for dcd::state_history_plugin:
...
```console
Config Options for dcd::state_history_plugin:
  ...
  --state-history-archive-dir arg (="archive")
                                        ...
                                        they won't be accessed by dcdnode 
                                        anymore.
...
### history-tools
  ...
  * [Source code](https://github.com/DCD/history-tools/)
  * [Documentation](https://dcd.github.io/history-tools/)
...
```console
# config.ini
plugin = dcd::chain_plugin --disable-replay-opts
```
```sh
# command-line
dcdnode ... --plugin dcd::chain_plugin --disable-replay-opts
```
