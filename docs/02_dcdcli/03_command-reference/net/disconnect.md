## Command
```sh
dcdcli net disconnect [OPTIONS] host
```
...
## Command Usage
The following information shows the different positionals and options you can use with the `dcdcli net disconnect` command:
...
```sh
dcdcli net disconnect localhost:9002
```
**Output:**
```console
"connection removed"
...
```sh
dcdcli -u http://127.0.0.1:8001 net disconnect localhost:9002
```
**Output:**
```console
"connection removed"
