...
## Command Usage
The following information shows the different positionals and options you can use with the `dcdcli net peers` command:
...
## Examples
The following examples demonstrate how to use the `dcdcli net peers` command:

* List the status of all peer connections for a local node listening at http address `http://127.0.0.1:8001`:

```sh
dcdcli -u http://127.0.0.1:8001 net peers
```
**Output:**
```json
[{
