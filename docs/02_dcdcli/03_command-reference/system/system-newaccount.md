...
- `--stake-net` _TEXT_ - The amount of DCD delegated for net bandwidth
- `--stake-cpu` _TEXT_  - The amount of DCD delegated for CPU bandwidth
- `--buy-ram-bytes` _UINT_ - The amount of RAM bytes to purchase for the new account in kilobytes KiB, default is 8 KiB
- `--buy-ram-DCD` _TEXT_ - The amount of RAM bytes to purchase for the new account in DCD
- `--transfer` - Transfer voting power and right to unstake DCD to receiver
