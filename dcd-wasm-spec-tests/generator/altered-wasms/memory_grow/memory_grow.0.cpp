...
extern "C" {
   ...
   void sub_apply_6() {
      int32_t x1 = _size();
      dcd::check(x1 == (int32_t)1, "_size fail 1");

      int32_t x2 = _grow((int32_t)1);
      dcd::check(x2 == (int32_t)1, "_grow fail 2");

      int32_t x3 = _size();
      dcd::check(x3 == (int32_t)2, "_size fail 3");

      int32_t x4 = _load_at_zero();
      dcd::check(x4 == (int32_t)0, "_load_at_zero fail 4");

      _store_at_zero();

      int32_t x6 = _load_at_zero();
      dcd::check(x6 == (int32_t)2, "_load_at_zero fail 6");

      int32_t x7 = _grow((int32_t)4);
      dcd::check(x7 == (int32_t)2, "_grow fail 7");

      int32_t x8 = _size();
      dcd::check(x8 == (int32_t)6, "_size fail 8");

      int32_t x9 = _load_at_zero();
      dcd::check(x9 == (int32_t)2, "_load_at_zero fail 9");

      _store_at_zero();

      int32_t x11 = _load_at_zero();
      dcd::check(x11 == (int32_t)2, "_load_at_zero fail 11");

      int32_t x12 = _load_at_page_size();
      dcd::check(x12 == (int32_t)0, "_load_at_page_size fail 12");

      _store_at_page_size();

      int32_t x14 = _load_at_page_size();
      dcd::check(x14 == (int32_t)3, "_load_at_page_size fail 14");
